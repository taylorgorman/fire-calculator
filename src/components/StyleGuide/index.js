...
export default function () {
  ...
  <div className="container">
    ...
    <p>Lorem ipsum dolor sit amet, <em>consectetur adipiscing</em> elit. Mauris id arcu in lectus tempus semper. <strong>Nullam ut odio pellentesque,</strong> ultricies ligula nec, luctus dui. <a href="/">Maecenas vel enim</a> eu neque porta maximus sit amet nec augue.</p>
    { [1,2,3,4,5,6].map( i => {
      const Tag = 'h' + i
    ...
    <ul>
      ...
      <li>Quisque dignissim, sapien quis fermentum rhoncus, velit elit finibus purus, nec tempus ex risus luctus lectus</li>
    </ul>
    <ol>
      <li>Maecenas faucibus, risus vel cursus pellentesque, dui neque tempor enim, in tristique sem justo quis quam</li>
